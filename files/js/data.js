...
const originalData = {
  ...
  petList: [
    ...
    { name: 'Athos', fragments: 0, img: 163, farm: true, index: 51, defaultTier: 16 },
    { name: 'Grizzle', fragments: 0, img: 164, farm: true, index: 52, defaultTier: 17 },
    { name: 'Raven', fragments: 0, img: 165, farm: true, index: 53, defaultTier: 18 },
    { name: 'Leyak', fragments: 0, img: 166, farm: true, index: 54, defaultTier: 19 },
    ...
    { name: 'Little Hawk', fragments: 0, img: 183, farm: true, index: 55, defaultTier: 56 },
    { name: 'Foxy', fragments: 0, img: 184, farm: true, index: 56, defaultTier: 57 },
    { name: 'Shadow', fragments: 0, img: 185, farm: true, index: 57, defaultTier: 58 },
    { name: 'Snow Bear', fragments: 0, img: 186, farm: true, index: 58, defaultTier: 59 },
