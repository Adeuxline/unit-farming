...
const originalData = {
  ...
  petList: [
    ...
    { name: 'Astral Captain', fragments: 0, needed: 10, img: 193, index: 46, defaultTier: 6 },
    { name: 'Elf Sage', fragments: 0, needed: 15, img: 185, index: 47, defaultTier: 7 },
    { name: 'Windwalker', fragments: 0, needed: 30, img: 177, index: 48, defaultTier: 8 },
    { name: 'Elementalist', fragments: 0, needed: 27, img: 169, index: 49, defaultTier: 9 },
    { name: 'Hippogriff', fragments: 0, needed: 20, img: 161, index: 50, defaultTier: 10 },
    { name: 'Shadow Knight', fragments: 0, needed: 1, img: 195, index: 76, defaultTier: 11 },
    { name: 'Crow Knight', fragments: 0, needed: 27, img: 187, index: 77, defaultTier: 12 },
    { name: 'Abyss Mage', fragments: 0, needed: 30, img: 179, index: 78, defaultTier: 13 },
    { name: 'Dark Elf', fragments: 0, needed: 15, img: 171, index: 79, defaultTier: 14 },
    { name: 'Dark Spirit', fragments: 0, needed: 12, img: 163, index: 80, defaultTier: 15 },
    { name: 'War Bear Rider', fragments: 0, needed: 1, img: 197, index: 106, defaultTier: 16 },
    { name: 'Rangda', fragments: 0, needed: 15, img: 173, index: 107, defaultTier: 17 },
    { name: 'Siren', fragments: 0, needed: 30, img: 181, index: 108, defaultTier: 18 },
    { name: 'Frost Demon', fragments: 0, needed: 24, img: 173, index: 109, defaultTier: 19 },
    { name: 'Blade Master', fragments: 0, needed: 12, img: 165, index: 110, defaultTier: 20 },
  ],
  SHList: [],
  KL: 100,
  entries: 10,
